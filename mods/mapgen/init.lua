minetest.register_alias("mapgen_stone", "murk:stone_1")
...
minetest.register_alias("mapgen_cobble", "murk:stone_1_cobble")
minetest.register_alias("mapgen_stair_cobble", "murk:stone_1_cobble_stair")
